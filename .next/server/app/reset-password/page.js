...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 41123)), "D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\reset-password\\page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 46624)), "D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\loading.tsx"],
    ...
    const pages = ["D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\reset-password\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 27146))
...
/* harmony import */ var _mui_lab__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(99433);
/* harmony import */ var _mui_lab__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_mui_lab__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _app_DashboardLayout_components_container_PageContainer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(68046);
...
/* harmony import */ var _services_API__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(82415);
/* harmony import */ var _GlobalRedux_Features_Alert_alertSlice__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(68205);
/* harmony import */ var jwt_decode__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(33802);
...
/* harmony import */ var sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(39881);
...
/* harmony import */ var _services_emailValidation__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(98247);
...
const ResetPassword = (props)=>{
    const paramString = (0,next_navigation__WEBPACK_IMPORTED_MODULE_4__.useSearchParams)();
    const [email, setEmail] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const [param, setParam] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(paramString.get("token"));
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        if (param) {
            try {
                let decoded = jwt_decode__WEBPACK_IMPORTED_MODULE_7___default()(param);
                setEmail(decoded.email);
            } catch (e) {
                sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_8___default().fire({
                    title: "Error!",
                    text: "Invalid Token",
                    icon: "error",
    ...
    const submit = ()=>{
        if (email && email.length > 1) {
            if ((0,_services_emailValidation__WEBPACK_IMPORTED_MODULE_9__/* .ValidateEmail */ .J)(email)) {
                if (password.length > 6) {
                    if (password == conPassword) {
                        setDisable(true);
                        setLoading(true);
                        _services_API__WEBPACK_IMPORTED_MODULE_5__/* .LoginRegistrationAPI.resetPassword */ .o.resetPassword({
                            password: password,
                            email: email
                        }).then((response)=>{
                            if (response.status == 202) {
                                ...
                                dispatch((0,_GlobalRedux_Features_Alert_alertSlice__WEBPACK_IMPORTED_MODULE_6__/* .setAlert */ .br)({
                                    title: "Error",
                                    icon: "error",
                                    text: "Error occured"
                                }));
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_app_DashboardLayout_components_container_PageContainer__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
        title: "Login",
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_10__.Box, {
            ...
            children: [
                ...
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_10__.Grid, {
                    container: true,
                    spacing: 0,
                    justifyContent: "center",
                    sx: {
                    ...
                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_10__.Grid, {
                        item: true,
                        xs: 12,
                        sm: 12,
                        lg: 4,
                        ...
                        justifyContent: "center",
                        alignItems: "center",
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_10__.Card, {
                            elevation: 9,
                            sx: {
                                p: 4,
                                zIndex: 1,
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_10__.Stack, {
                                        children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_10__.Box, {
                                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_lab__WEBPACK_IMPORTED_MODULE_11__.LoadingButton, {
                                            color: "primary",
                                            variant: "contained",
                                            size: "large",
                                            fullWidth: true,
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\projects\tushar\99robots\seopilot-temp\src\app\reset-password\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [859,706,85,107,248,62,433,881,802,620,415,338], () => (__webpack_exec__(8384)));
