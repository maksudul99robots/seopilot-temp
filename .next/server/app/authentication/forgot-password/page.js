...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8856)), "D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\authentication\\forgot-password\\page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 46624)), "D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\loading.tsx"],
    ...
    const pages = ["D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\authentication\\forgot-password\\page.tsx"];
    ...
    const originalPathname = "/authentication/forgot-password/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 18416))
...
/* harmony import */ var _app_DashboardLayout_components_container_PageContainer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(68046);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(18038);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _app_GlobalRedux_Features_Alert_alertSlice__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(68205);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1560);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_redux__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _app_services_emailValidation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(98247);
/* harmony import */ var _app_services_API__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(82415);
/* harmony import */ var next_navigation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(59483);
/* harmony import */ var next_navigation__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(next_navigation__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _mui_lab_LoadingButton__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(78062);
...
const ForgotPassword = ()=>{
    const paramString = (0,next_navigation__WEBPACK_IMPORTED_MODULE_6__.useSearchParams)();
    const [email, setEmail] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [password, setPassword] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [isEmailValid, setIsEmailValid] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
    const [disable, setDisable] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(true);
    const [loading, setLoading] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
    const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_4__.useDispatch)();
    const router = (0,next_navigation__WEBPACK_IMPORTED_MODULE_6__.useRouter)();
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        if (email.length > 1) {
            if ((0,_app_services_emailValidation__WEBPACK_IMPORTED_MODULE_7__/* .ValidateEmail */ .J)(email)) {
    ...
    const submit = ()=>{
        if (email && email.length > 1) {
            if (isEmailValid) {
                setLoading(true);
                setDisable(true);
                _app_services_API__WEBPACK_IMPORTED_MODULE_5__/* .LoginRegistrationAPI.sendForgotPasswordEmail */ .o.sendForgotPasswordEmail({
                    email: email
                }).then((response)=>{
                    if (response.status == 201) {
                        dispatch((0,_app_GlobalRedux_Features_Alert_alertSlice__WEBPACK_IMPORTED_MODULE_3__/* .setAlert */ .br)({
                            title: "Sent",
                            icon: "success",
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_8__.Box, {
            ...
            children: [
                ...
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_8__.Grid, {
                    ...
                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_8__.Grid, {
                        item: true,
                        xs: 12,
                        sm: 12,
                        lg: 4,
                        ...
                        justifyContent: "center",
                        alignItems: "center",
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_8__.Card, {
                            elevation: 9,
                            sx: {
                                p: 4,
                                zIndex: 1,
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_8__.Box, {
                                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_lab_LoadingButton__WEBPACK_IMPORTED_MODULE_9___default()), {
                                            color: "primary",
                                            variant: "contained",
                                            size: "large",
                                            fullWidth: true,
                                            type: "submit",
                                            style: {
                                                color: !isEmailValid && disable ? "#595959" : "white",
                                                marginTop: "30px"
                                            },
                                            onClick: ()=>submit(),
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\projects\tushar\99robots\seopilot-temp\src\app\authentication\forgot-password\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [859,706,85,107,248,62,620,415,338], () => (__webpack_exec__(10218)));
