...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 49554)), "D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\authentication\\login\\page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 46624)), "D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\loading.tsx"],
    ...
    const pages = ["D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\authentication\\login\\page.tsx"];
...
var lab_node = __webpack_require__(99433);
;// CONCATENATED MODULE: ./src/app/authentication/auth/AuthLogin.tsx





const AuthLogin = ({ title , subtitle , subtext , submit , setPassword , setEmail , isEmailValid , disable , loading  })=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            title ? /*#__PURE__*/ jsx_runtime_.jsx(node.Typography, {
                fontWeight: "700",
                variant: "h2",
                mb: 1,
                children: title
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(node.Box, {
                children: /*#__PURE__*/ jsx_runtime_.jsx(lab_node.LoadingButton, {
                    color: "primary",
                    variant: "contained",
                    size: "large",
                    fullWidth: true,
...
/* harmony default export */ const auth_AuthLogin = (AuthLogin);
...
// EXTERNAL MODULE: ./src/app/services/emailValidation.ts
var emailValidation = __webpack_require__(98247);
// EXTERNAL MODULE: ./src/app/services/API.ts
var API = __webpack_require__(82415);
;// CONCATENATED MODULE: ./src/app/services/UserService.ts
let userValue = (/* unused pure expression or super */ null && (undefined));
const getUserValue = ()=>{
    return userValue;
};
...
;// CONCATENATED MODULE: ./src/app/authentication/login/page.tsx
...
const Login2 = ()=>{
    ...
    const [isEmailValid, setIsEmailValid] = (0,react_.useState)(false);
    const [disable, setDisable] = (0,react_.useState)(true);
    ...
    const submit = ()=>{
        if (email && email.length > 1) {
            if (password && password.length < 7) dispatch((0,alertSlice/* setAlert */.br)({
                title: "Error",
                icon: "error",
                ...
                setLoading(true);
                API/* LoginRegistrationAPI.login */.o.login({
                    email,
                    password
                }).then((res)=>{
                    // console.log(res)
                ...
                /*#__PURE__*/ jsx_runtime_.jsx(node.Grid, {
                    ...
                    children: /*#__PURE__*/ jsx_runtime_.jsx(node.Grid, {
                        ...
                        children: /*#__PURE__*/ jsx_runtime_.jsx(node.Card, {
                            ...
                            children: /*#__PURE__*/ jsx_runtime_.jsx(auth_AuthLogin, {
                                setEmail: setEmail,
                                ...
                                disable: disable,
                                loading: loading,
                                subtext: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
                                    children: [
                                        /*#__PURE__*/ jsx_runtime_.jsx(node.Typography, {
                                            variant: "h3",
                                            textAlign: "center",
...
/* harmony default export */ const page = (Login2);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\projects\tushar\99robots\seopilot-temp\src\app\authentication\login\page.tsx`)
