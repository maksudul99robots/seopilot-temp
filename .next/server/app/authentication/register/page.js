...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 81745)), "D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\authentication\\register\\page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 46624)), "D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\loading.tsx"],
    ...
    const pages = ["D:\\projects\\tushar\\99robots\\seopilot-temp\\src\\app\\authentication\\register\\page.tsx"];
    ...
    const originalPathname = "/authentication/register/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 77376))
...
;// CONCATENATED MODULE: ./src/app/authentication/auth/AuthRegister.tsx





const AuthRegister = ({ title , subtitle , subtext , submit , setFirstname , setLastname , setEmail , setPassword , isEmailValid , setConfirmPassword , disable , loading  })=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)(node.Box, {
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx(lab_node.LoadingButton, {
                        color: "primary",
                        variant: "contained",
                        size: "large",
                        style: {
...
/* harmony default export */ const auth_AuthRegister = (AuthRegister);
...
const Register2 = ()=>{
    ...
    const [confirmPassword, setConfirmPassword] = (0,react_.useState)("");
    const [firstName, setFirstname] = (0,react_.useState)("");
    const [lastName, setLastname] = (0,react_.useState)("");
    const [isEmailValid, setIsEmailValid] = (0,react_.useState)(true);
        ...
        if (isEmailValid) {
            if (password.length > 6) {
                if (password == confirmPassword) {
                    setLoading(true);
                    API/* LoginRegistrationAPI.register */.o.register({
                        email,
                        password,
                        confirmPassword,
                        firstName,
...
/* harmony default export */ const page = (Register2);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\projects\tushar\99robots\seopilot-temp\src\app\authentication\register\page.tsx`)
